...
def weiner_process_uniform_parameters_fn(delta, x0, dt=1):
    ...
    If a parameter is set as an iterable of form [a, b] - uniformly randomly samples parameter value
...
def ornshtein_uhlenbeck_log_uniform_parameters_fn(mu, l, sigma, x0=None, dt=1):
    """
    Provides parameters for OU process.
    If `mu`, `sigma` is set as iterable of form [a, b] - uniformly randomly samples parameter value
    from a given interval; `l` is sampled from log-uniform distribution
